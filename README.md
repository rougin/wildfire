...
Wildfire is a wrapper for [Query Builder Class](https://codeigniter.com/user_guide/database/query_builder.html) from [Codeigniter](https://codeigniter.com) framework. Inspired also by the [Eloquent ORM](https://laravel.com/docs/5.6/eloquent) from Laravel.
